...
namespace LocalBandsList.Models
{
  public class LocalBandsListContext : DbContext
  {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      ...
      new Band { BandId = 7, Name = "CON", Genre = "rock", Bio = "A group of jabronies that liked to rock", YearFormed = "2013", VideoLink = "", MusicLink = "https://soundcloud.com/wearecon/allison", Gigging = false, Together = true, UserId = 2 },
      new Band { BandId = 6, Name = "Smooth Richard", Genre = "psychedelic rock", Bio = "A well-oiled rock machine, pumping out tunes for early-morning smoke sessions", YearFormed = "2017", VideoLink = "", MusicLink = "https://soundcloud.com/smoothrichard/lintfire", ZipCode = "98125", Gigging = true, Together = true, UserId = 2 }
      );
